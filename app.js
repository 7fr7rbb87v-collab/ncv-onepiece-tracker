...
function renderDeals(deals) {
  ...
  if (!deals.length) {
    grid.innerHTML = "<p>No deals found yet. Add listings to manual_listings.csv and run the workflow.</p>";
    return;
  }
  ...
  deals.forEach(deal => {
    ...
    card.innerHTML = `
      ...
      <div class="cardBody">
        ...
        <button onclick="showChart('${deal.product_id}', '${deal.keyword}')">View Chart</button>
